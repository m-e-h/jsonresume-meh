...
describe('DataProcessor', () => {
  ...
  describe('Data Loading', () => {
    it('should load resume data successfully', async () => {
      global.fetch.mockResolvedValue(createMockResponse(MOCK_RESUME_DATA));
    ...
    it('should handle network errors', async () => {
      global.fetch.mockRejectedValue(createMockError('Network failed'));
  ...
  describe('Default Value Application', () => {
    ...
    it('should handle invalid input gracefully', () => {
      [null, "invalid", 123].forEach(invalidInput => {
