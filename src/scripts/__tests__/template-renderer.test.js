...
describe('TemplateRenderer', () => {
  ...
  beforeEach(() => {
    ...
    global.fetch = jest.fn().mockResolvedValue(createMockResponse('mock content'));
  ...
  describe('Template Loading', () => {
    it('should load template file successfully', async () => {
      ...
      global.fetch.mockResolvedValueOnce(createMockResponse(mockContent));
  ...
  describe('Error Handling', () => {
    ...
    it('should handle rendering errors gracefully', async () => {
      global.fetch.mockResolvedValueOnce(createMockResponse('{{invalid.template.syntax'));
